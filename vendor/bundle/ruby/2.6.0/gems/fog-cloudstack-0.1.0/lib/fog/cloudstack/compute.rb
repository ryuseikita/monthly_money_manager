...
module Fog
  module Cloudstack
    class Compute < Fog::Service
      ...
      class BadRequest < Fog::Cloudstack::Compute::Error; end
      class Unauthorized < Fog::Cloudstack::Compute::Error; end
      ...
      private
        ...
        def issue_request(params={},headers={},method='GET',expects=200)
          begin
            ...
            case error_code
            when 401
              raise Fog::Cloudstack::Compute::Unauthorized, error_text
            when 431
              raise Fog::Cloudstack::Compute::BadRequest, error_text
            else
              raise Fog::Cloudstack::Compute::Error, error_text
            end
          end
